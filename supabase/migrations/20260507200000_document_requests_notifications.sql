-- =============================================================================
-- Push + Email notifications for the Documentos module
--
-- Trigger 1 (INSERT)  → notify recipient that they have a document to sign
-- Trigger 2 (UPDATE)  → notify document creator when recipient signs/submits
-- =============================================================================


-- =============================================================================
-- 1. Notify recipient when a new document_request is created
-- =============================================================================
...
DECLARE
  ...
  v_desc        text;
BEGIN
  -- Only notify if there is a recipient
...
DECLARE
  ...
  v_student    text;
BEGIN
  -- Only fire when transitioning from pending → signed/submitted
