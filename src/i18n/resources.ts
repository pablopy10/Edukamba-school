...
import ptDefinicoes from "@/locales/pt/definicoes.json";
import enDefinicoes from "@/locales/en/definicoes.json";
import frDefinicoes from "@/locales/fr/definicoes.json";
...
const mergePages = (
  ...
  extras: {
    ...
    definicoes: typeof ptDefinicoes;
  },
) => ({ ...base, ...extras });
